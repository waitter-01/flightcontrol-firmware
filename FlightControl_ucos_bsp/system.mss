...
BEGIN PROCESSOR
 ...
 PARAMETER extra_compiler_flags = -mcpu=cortex-a9 -mfpu=vfpv3 -mfloat-abi=hard -nostartfiles -g -Wall -Wextra -DXPLAT_versal=5
END
...
BEGIN LIBRARY
 ...
 PARAMETER PROC_INSTANCE = ps7_cortexa9_0
 PARAMETER OS_CFG_SCHED_LOCK_TIME_MEAS_EN = true
 PARAMETER OS_CFG_STAT_TASK_EN = true
 PARAMETER OS_CFG_STAT_TASK_STK_CHK_EN = true
 PARAMETER OS_CFG_TASK_PROFILE_EN = true
 PARAMETER OS_CFG_TS_EN = true
END
